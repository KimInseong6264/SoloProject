...
public class LeeSangSkill1Motion1 : ISkillMotion
{
    private LeeSangSKill1 _skill;
    private int _coinCount;
    private int _basicSkillValue;
    private int _coinValue;
    private float _motionTime = 2;
    


    // 모션 추가시, MotionList에 생성해야 함
    public LeeSangSkill1Motion1(LeeSangSKill1 skill)
    {
        _skill = skill;
