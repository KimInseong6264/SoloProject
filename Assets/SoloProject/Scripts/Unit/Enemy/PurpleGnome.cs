...
public class PurpleGnome : MonoBehaviour, IUnit
{
    ...
    public void InitSkillList()
    {
        ...
        SkillList.Add(new PurpleGnomeSill1(skillName[0], coinCount[0], basicSkillValue[0], coinValue[0]));
        SkillList.Add(new PurpleGnomeSill1(skillName[1], coinCount[1], basicSkillValue[1], coinValue[1]));
    }
